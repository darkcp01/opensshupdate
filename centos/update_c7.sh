...
#./config  --prefix=/usr/local/openssl enable-ssl enable-ssl3 enable-ssl3-method enable-tls  enable-tls1_3 shared zlib >> /home/update/info$
./config  --prefix=/usr/local/openssl shared zlib >> /home/update/info$
{DATE_DAY}.log 2>& 1
...
mv -b /usr/local/bin/ssh* /usr/local/bin/sftp /home/update/bin/ >/dev/null 2>&1
